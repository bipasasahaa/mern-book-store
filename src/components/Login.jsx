                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                {error ? <p className='text-red-400 text-base'> Email or Password is incorrect 
                                </p> : ""}

                                <p>If you haven't an account, <Link to="/sign-up" className="text-blue-700 underline">Sign up </Link> here</p>
                                <div className="relative">
                                    <button className="bg-blue-500 text-white rounded-md px-5 py-1">Login</button>
                                </div>
                            </form>
                        </div>
